...
public class text_HandWrite_PaintView extends View {
    ...
    public text_HandWrite_PaintView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setTextView(TextView t1, TextView t2, TextView t3, TextView t4, LinearLayout ll) {
        textView1 = t1;
        textView2 = t2;
        textView3 = t3;
        textView4 = t4;
    ...
    public void setModel(text_HandWrite_HangulClassifier classifier) {
        this.classifier = classifier;
    }

    private void classify() {
        float pixels[] = this.getPixelData();
        String currentTopLabels[] = classifier.classify(pixels);
        altLayout.setVisibility(View.VISIBLE);
        textView1.setText(currentTopLabels[0]);
        textView2.setText(currentTopLabels[1]);
        textView3.setText(currentTopLabels[2]);
        textView4.setText(currentTopLabels[3]);
    }
