...
public class text_HandWrite_HangulClassifier {
     ...
     */
    public static text_HandWrite_HangulClassifier create(AssetManager assetManager,
                                                         String modelPath, String labelFile, int inputDimension,
                                                         String inputName, String keepProbName,
                                                         String outputName) throws IOException {

        text_HandWrite_HangulClassifier classifier = new text_HandWrite_HangulClassifier();
